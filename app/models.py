...
class Productos(Base):
    ...
    serving_quantity_g = Column(Float)
    product_quantity_g = Column(Float)
    caloria_kcal_100g = Column(Float)
    grasa_g_100g = Column(Float)
    carbohidrato_g_100g = Column(Float)
    proteina_g_100g = Column(Float)
    caloria_kcal_serving = Column(Float)
    grasa_g_serving = Column(Float)
    carbohidrato_g_serving = Column(Float)
    proteina_g_serving = Column(Float)
